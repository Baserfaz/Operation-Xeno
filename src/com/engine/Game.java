...
public class Game extends Canvas implements Runnable {
    ...
    public static final String TITLE               = "Operation Xeno";
    ...
    public void setUnitManager(UnitManager unitManager) { this.unitManager = unitManager; }
    public Level getLevel() { return this.level; }
    public void setWorld(Level level) { this.level = level; }
